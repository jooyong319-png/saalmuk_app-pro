...
export default function DailyCommunity({
  setCurrentPage,
  goBack,
}: {
  ...
  const posts = [
    {
      ...
      time: "방금 전",
      content: "📢 [공지] 이번 주 당첨 확률 높은 이벤트 TOP 5 정리해봤습니다!",
      image: null,
      likes: 156,
      comments: 42,
      category: "공지",
    ...
    },
    {
      ...
      time: "15분 전",
      content:
        "CU 퀴즈 정답 공유합니다! 3번 문제 답 '편의점' 이에요 ㅎㅎ 다들 당첨되세요 🍀",
      image: null,
      likes: 89,
      comments: 31,
      category: "베스트글",
    ...
    },
    {
      ...
      time: "1시간 전",
      content:
        "와 드디어 스타벅스 아메리카노 당첨됐어요!!! 3개월 동안 매일 응모한 보람이 ㅠㅠ 인증합니다",
      image:
    ...
    },
    {
      ...
      time: "2시간 전",
      content:
        "이번 달 당첨 현황: 기프티콘 7개, 상품권 2만원어치 ㅋㅋㅋ 쌀먹 최고 🚀",
      image:
    ...
    },
    {
      ...
      time: "3시간 전",
      content:
        "질문있어요! 이벤트 응모할 때 당첨 확률 높이는 꿀팁 있을까요? 아직 한 번도 당첨 못 받았어요 ㅠㅠ",
      image: null,
      likes: 45,
      comments: 52,
      category: "일반",
    ...
    },
    {
      ...
      time: "4시간 전",
      content:
        "배민 1만원권 장터에 올렸습니다! 8,500원에 판매해요~ 유효기간 D-30",
      image: null,
      likes: 23,
      comments: 8,
      category: "일반",
    ...
    },
    {
      ...
      time: "5시간 전",
      content:
        "토스 출석체크 100일 연속 달성!! 이거 꾸준히 하면 한 달에 만원은 벌어요 ㅎㅎ",
      image: null,
      likes: 178,
      comments: 34,
      category: "베스트글",
    ...
    },
    {
      ...
      time: "1일 전",
      content:
        "네이버 웹툰 공모전 대상 받았습니다!!! 상금 500만원 ㄷㄷ 쌀먹닷컴에서 정보 보고 응모했어요 감사합니다 🙏",
      image:
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="sticky top-0 z-50 bg-white flex items-center justify-between px-4 py-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold">생활쌀먹</span>
        </div>
