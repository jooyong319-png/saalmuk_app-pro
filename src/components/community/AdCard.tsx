...
export default function AdCard({ ad, index = 0 }: AdCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* 미디어 */}
      {ad.media && (
        <div className="relative bg-black cursor-pointer" onClick={handleClick}>
          {ad.media.type === "video" ? (
            <video
              src={ad.media.src}
      ...
      <div className="p-4 pt-3">
        <div className="flex items-center justify-between">
          <p className="text-[15px] text-gray-700 flex-1 truncate">
            {ad.title}
          </p>
          <button
            className="ml-3 px-4 py-1.5 bg-gray-100 text-gray-700 text-[13px] font-semibold rounded-full hover:bg-gray-200 active:bg-gray-300 transition-colors shrink-0"
            onClick={handleClick}
          >
            더 보기
          </button>
